    ...
    >
      ...
      <div className="flex items-center space-x-2 font-medium text-xs !mt-3">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="uppercase py-2 px-4 rounded-md outline outline-slate-500 outline-0 transition-all hover:outline-4"
          style={{
            background:
              "conic-gradient(at right bottom, rgb(51, 65, 85), rgb(51, 65, 85), rgb(51, 65, 85))",
          }}
        >
          Demo
        </a>
